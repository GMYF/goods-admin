package com.light.springboot.core.service.common;

import com.light.springboot.core.dao.EmailMapper;
import com.light.springboot.core.domain.email.Email;
import com.light.springboot.core.domain.email.EmailConfig;
